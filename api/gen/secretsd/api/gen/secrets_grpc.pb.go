...
const (
	Secrets_Put_FullMethodName = "/secretsd.v1.Secrets/Put"
	Secrets_Get_FullMethodName = "/secretsd.v1.Secrets/Get"
)
...
func (c *secretsClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PutResponse)
	err := c.cc.Invoke(ctx, Secrets_Put_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSecretsServer) Put(context.Context, *PutRequest) (*PutResponse, error) {
...
func _Secrets_Put_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Secrets_Put_FullMethodName,
	}
